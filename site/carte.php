...
<head>
  ...
  <script type="module" src="../Leaflet.markercluster-1.4.1/src/index.js"></script>
  ...
  <script src="../script/L.Control.ZoomMin.js"></script>
  <link rel="stylesheet" href="../marker/css/leaflet.extra-markers.min.css">
  <script src="../marker/js/leaflet.extra-markers.min.js"></script>
...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Carte</h6>
        </nav>
    ...
    <div id="map container-fluid py-4" class="sidebar-map" style="width: 100%; height: 80%;">
